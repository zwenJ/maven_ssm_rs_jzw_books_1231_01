...
<div class="w960">
    ...
    <div class="w740 right">
        ...
        <jsp:include page="../../common/select_order.jsp" flush="true">
            <jsp:param name="SelectOrder" value="order/showorder/user/orders/order.controller?status=1&bookType=${BooksZxPtUser}"/>
        </jsp:include>
                ...
                <c:if test="${not empty MyOrderList}">
                    ...
                    <c:forEach items="${MyOrderList}" var="order">
                        <tr style="font-size: 12px">
                            ...
                            <td width="10%" class="text">
                                <a href="javascript:fun_update_order('${order.orderId}',2);">立即付款</a>
                            </td>
                        </tr>
                    </c:forEach>
        ...
        <c:if test="${not empty MyOrderList}">
                <jsp:include page="../../common/page.jsp" flush="true">
                    <jsp:param name="pathPage" value="order/showorder/user/orders/order.controller?status=1&bookType=${BooksZxPtUser}"/>
                </jsp:include>
        </c:if>
