...
<div class="w960">
    ...
    <div class="w740 right">
        ...
        <jsp:include page="../../common/select_order.jsp" flush="true">
            <jsp:param name="SelectOrder" value="order/showorder/manager/order/order3.controller?status=4"/>
        </jsp:include>
        ...
        <div class="order02">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <c:if test="${empty MyOrderList}">
                    <tr style="font-size: 12px">
                        <td colspan="5" style="text-align: center">暂无已签收订单</td>
                    </tr>
                </c:if>
        ...
        <c:if test="${not empty MyOrderList}">
            <jsp:include page="../../common/page.jsp" flush="true">
                <jsp:param name="pathPage" value="order/showorder/manager/order/order3.controller?status=4"/>
            </jsp:include>
        </c:if>
